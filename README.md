...
[![Version](https://img.shields.io/badge/version-0.1.3-blue)](https://github.com/benbasha/Claude-Autopilot/releases/tag/v0.1.3)
...
3. Or install from VSIX: `code --install-extension claude-autopilot-0.1.3.vsix`
