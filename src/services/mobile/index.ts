...
export class MobileServer {
    ...
    private setupRoutes(): void {
        ...
        // Simplified Git API - Only uncommitted changes
        ...
        this.app.get('/api/git/file-diff', async (req: Request, res: Response) => {
            try {
                const filePath = req.query.path as string;
                ...
                // Always compare against HEAD (uncommitted changes)
